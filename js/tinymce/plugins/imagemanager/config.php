<?php
        ...
        $mcImageManagerConfig['filesystem.path'] = '../../../../upload/redactor/'; // absolute or relative from this script path, optional.
        $mcImageManagerConfig['filesystem.rootpath'] = 'images=../../../../upload/redactor'; // absolute or relative from this script path, required.

<?php
        ...
        $mcFileManagerConfig['filesystem.path'] = '../../../../upload/'; // absolute or relative from this script path.
        $mcFileManagerConfig['filesystem.rootpath'] = '../../../../upload/'; // absolute or relative from this script path.

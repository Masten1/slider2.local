...
').onmouseout = mouseOut.bindAsEventListener();
    ...
    <DIV id="<?php echo $this->_tpl_vars['nodeKey']; ?>
_popup" style="z-index: 1; position: absolute; left: 0; top: 0; display: none; border: 1px solid black; background-color: #FFFFFF; background-image: url('<?php echo $this->_tpl_vars['fvConfig']->get('dir_web_root'); ?>

...
smarty_core_load_plugins(array('plugins' => array(array('function', 'show_module', 'main.tpl', 23, false),array('modifier', 'urlto', 'main.tpl', 31, false),)), $this); ?>
    ...
    <body id="documentBody">
        <div id="scrolobble">
            <div id="header">
                ...
                <div id="actiontrace"></div>

                <?php if ($this->_tpl_vars['fvConfig']->get('access.enable')): ?>
                    <?php $this->assign('LoggedManager', $this->_tpl_vars['currentPage']->getLoggedUser()); ?>
                    <div id="hello" class="text"><?php if ($this->_tpl_vars['LoggedManager']): ?>Добро пожаловать, <B><?php echo $this->_tpl_vars['LoggedManager']->name; ?>
! [<a href="/backend/">на главную</a>] [<a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['fvConfig']->get('access.do_logout'))) ? $this->_run_mod_handler('urlto', true, $_tmp) : smarty_modifier_urlto($_tmp)); ?>
">выйти</a>]<?php endif; ?></div>
                <?php endif; ?>
            </div>
            
            <?php if (@debug): ?><script>var debug = true;</script><?php endif; ?>

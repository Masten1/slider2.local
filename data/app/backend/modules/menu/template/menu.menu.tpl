...
{if is_array($ModuleNode.child_nodes)}  
    ...
    <DIV id="{$nodeKey}_popup" style="z-index: 1; position: absolute; left: 0; top: 0; display: none; border: 1px solid black; background-color: #FFFFFF; background-image: url('{$fvConfig->get('dir_web_root')}img/bg_menu.gif'); background-repeat: repeat-y; background-position: left">

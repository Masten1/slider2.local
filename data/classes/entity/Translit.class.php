<?php
 class Translit {
    ...
    static function Transliterate($str, $encIn="utf-8", $encOut="utf-8"){
       $str = iconv($encIn, "utf-8", $str);
      for($i=0; $i<count( self::$cyr); $i++)
        $str = str_replace(self::$cyr[$i], self::$lat[$i], $str);

...
abstract class fvField {
    ...
    /** Сообщение об ошибке  */
    protected $messageInvalid = "Поле заполнено неправильно";
    ...
    const EDIT_METHOD_INPUT_AUTO = "inputauto";
    ...
    function set( $value ) {
        ...
        if ( $this->isLanguaged() ) {
            if ( !$this->lang )
                throw new EFieldError( "Please define language before set value of field" );

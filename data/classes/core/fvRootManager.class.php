<?php
    ...
    class fvRootManager{
        ...
        public function getAllByQuery( fvQuery $query, $keyName = null ){
            $result = array();
        ...
        function getOneInstance( $where = "", $order = "", $params = null ){
            ...
            if($this->rootObj->getEntity() == 'Page') fvAction::redirect404();
            else
                throw new EInstanceError( "Instance '{$this->rootObj->getEntity()}' doesn't exist" );
            /* else fvDispatcher::getInstance()->redirect(fvSite::$fvConfig->get('page_404'), 0, 404); */
        }
